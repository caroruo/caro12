...
public class Produktions_Manager extends Thread {
        ...
        while (true) {
            ...
            for (int i = 0; i < bestellungenInProduktion.size(); i++) {
                ...
                for (Produkt produkt : bestellung.liefereBestellteProdukte()) {
                    if (produkt.aktuellerZustand() != produkt.zustandProduktionFertig) {
                        allesFertig = false;
                        break;
                    }
                }
                ...
                if (allesFertig) {
                    ...
                    System.out.println("[Produktions_Manager] Bestellung " + bestellung.gibBestellungsNr() + " fertig produziert!");
    ...
    /**
     * Startet die Produktion einer Bestellung, indem Produkte den Robotern zugewiesen werden.
     * 
