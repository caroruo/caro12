    ...
    public void starteProduktion(Bestellung bestellung) {
        for (Produkt produkt : bestellung.liefereBestellteProdukte()) {
            if (produkt instanceof Standardtuer) {
                ...
                try {
                    meinLager.reserviereWaren(Standardtuer.gibHolzeinheiten(), Standardtuer.gibSchrauben(),
                            Standardtuer.gibFarbeinheiten(), Standardtuer.gibKartoneinheiten(), 0);
                ...
                //ablauf.add(verpackungsRoboter);
                try {
                    meinLager.reserviereWaren(Premiumtuer.gibHolzeinheiten(), Premiumtuer.gibSchrauben(),
                            Premiumtuer.gibFarbeinheiten(), Premiumtuer.gibKartoneinheiten(),
                            Premiumtuer.gibGlaseinheiten());
                    produkt.setzeProduktionsablauf(ablauf);
                } catch (IllegalArgumentException e) {
                    meinLager.lagerAuffuellen();
                }
