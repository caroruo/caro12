...
public class Produktions_ManagerTest {
    ...
    /**
     * Prüft, ob die Methode fuegeZuVerarbeitendeBestellungenHinzu eine Bestellung
     * korrekt zur
    ...
    public void testFuegeBestellungHinzu() {
        ...
        try {
            ...
            assertEquals(1, bestellungen.size(),
                    "Die Liste der zu verarbeitenden Bestellungen sollte eine Bestellung enthalten.");
    ...
    /**
     * Überprüft, ob der Produktions_Manager Bestellungen an den
     * Holzbearbeitungs_Roboter weiterleitet und korrekt verarbeitet.
     */
    @Test
