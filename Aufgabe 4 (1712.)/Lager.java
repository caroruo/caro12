 ...
 */
public class Lager {
    public final static int MAXHOLZEINHEITEN = 1000;
    public final static int MAXSCHRAUBEN = 5000;
    public final static int MAXFARBEEINHEITEN = 1000;
    public final static int MAXKARTONEINHEITEN = 1000;
    public final static int MAXGLASEINHEITEN = 100;
    ...
    /**
     * Methode gibt den Zustand der Materialien auf Lager an und liefert ihn zurück
     * @return Eine Liste mit den verfügbaren Materialien
     */
    public synchronized ArrayList<Integer> lagerBestandAusgeben() {
        ArrayList<Integer> bestand = new ArrayList<>();
        bestand.add(vorhandeneHolzeinheiten);
        bestand.add(vorhandeneSchrauben);
        bestand.add(vorhandeneFarbeeinheiten);
        bestand.add(vorhandeneKartoneinheiten);
        bestand.add(vorhandeneGlaseinheiten);

        // Optional: Lagerbestand in der Konsole ausgeben
